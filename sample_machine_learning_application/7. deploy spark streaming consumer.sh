...
curl -H "Content-Type: application/json" -X POST -d '
{
  ...
  "cmd": "pip install -r spark_streaming_kafka_consumer_requirements.txt; spark-2.1.0-bin-hadoop2.7/bin/spark-submit --jars spark-streaming-kafka-0-8-assembly_2.11-2.1.0.jar spark_streaming_kafka_consumer.py master:2181/kafka test",
  "cpus": 0.5,
  "mem": 128,
  "instances": 1,
  "uris": [
    "http://'${MESOS_MASTER_IP}'/file-server/spark_streaming_kafka_consumer_requirements.txt",
